...
import { FiCode, FiCamera, FiCoffee, FiBook, FiMessageCircle } from "react-icons/fi";
...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-amber-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <section className="pt-24 px-6 max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <img 
            ...
            alt="Nikhil Patel" 
            className="relative z-10 w-48 h-48 object-cover rounded-full border-8 border-white dark:border-gray-800 shadow-xl"
          />
        </motion.div>
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
          Full-Stack Developer & Creative Problem Solver with 8+ years of experience crafting digital solutions.
          Passionate about building intuitive experiences that marry technical excellence with human-centric design.
        </p>
      </section>

      {/* Core Expertise */}
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12 text-orange-600">Technical Arsenal</h2>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-orange-900 to-amber-600 rounded-2xl p-8 text-white">
          ...
          <div className="space-y-6">
            <p className="text-lg">
              &quot;I believe technology should empower, not complicate. Every line of code I write is guided by three principles:&quot;
            </p>
            <ul className="space-y-4 pl-6">
              <li className="relative before:absolute before:-left-6 before:top-2 before:w-3 before:h-3 before:bg-amber-300 before:rounded-full">
                <strong>Clarity over Cleverness:</strong> Maintainable code beats fancy shortcuts
              </li>
              <li className="relative before:absolute before:-left-6 before:top-2 before:w-3 before:h-3 before:bg-amber-300 before:rounded-full">
                <strong>User-Centric Execution:</strong> Technology should serve people, not the reverse
              </li>
              <li className="relative before:absolute before:-left-6 before:top-2 before:w-3 before:h-3 before:bg-amber-300 before:rounded-full">
                <strong>Ethical Innovation:</strong> Build solutions that make the web better for everyone
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* Balanced Lifestyle */}
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12 text-orange-600">Beyond the Keyboard</h2>
          ...
          <div className="space-y-8">
            <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Weekend street photographer capturing urban narratives. Currently exploring:
              </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Specialty pour-over enthusiast with a growing collection of single-origin beans
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Creating coding playlists that blend synthwave with classical piano
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Growing herbs and battling aphids in my apartment balcony jungle
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-6">
            ...
            <span className="bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent"> Meaningful</span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            Whether you have a project in mind or want to discuss ethical tech practices
          </p>
          <motion.button
