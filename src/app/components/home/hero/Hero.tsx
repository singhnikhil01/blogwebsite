  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hi, I'm Nikhil Singh, a Full Stack Developer and AI Enthusiast. Explore my portfolio and projects."
        />
        <meta
          name="keywords"
          content="Nikhil Singh, Full Stack Developer, AI Enthusiast, Web Development, Machine Learning"
        />
        ...
        <div className="mx-auto lg:mt-[10%] flex max-w-7xl flex-col-reverse items-center gap-12 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="/projects"
                className="flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 px-8 py-4 font-medium text-white shadow-lg shadow-blue-500/20"
              >
                Explore Portfolio
              ...
              <a
                ...
                className="flex items-center gap-2 rounded-full border border-gray-700 bg-gray-800/50 px-8 py-4 font-medium text-white backdrop-blur-sm transition-all hover:border-gray-600"
              >
                Download CV
            ...
            >
              <div className="relative aspect-square w-full max-w-xl sm:max-w-sm overflow-hidden">
                <MotionDiv
                  ...
                  className="relative h-full w-full overflow-hidden rounded-full border-4 border-white/10 backdrop-blur-lg"
                >
                  <Image
                ...
                <MotionDiv
                  ...
                  className="absolute inset-0 rounded-full border-2 border-transparent border-t-blue-800 border-r-orange-400"
                />
              </div>
            </MotionDiv>
          )}
